...
export default function AvailabilityPage() {
    ...
    async function load() {
        ...
        try {
            ...
            const foodRows: Row[] = foodSnap.docs
                .map((d) => {
                    ...
                    return {
                        ...
                        disponibile: typeof x.disponibile === "boolean" ? x.disponibile : true,
                    } as Row;
                })
            ...
            setRows([...foodRows, ...drinkRows].sort((a, b) => a.numericId - b.numericId));
        } catch (e) {
            console.error(e);
    ...
    async function toggleDisponibile(row: Row, value: boolean) {
        ...
        try {
            ...
            setMsg(`Salvato: ${row.name} → ${value ? "Disponibile" : "Non disponibile"}`);
        } catch (e) {
            console.error(e);
                                    ...
                                    <table style={{ width: "100%", borderCollapse: "collapse" }}>
                                        ...
                                        <tbody>
                                            {grouped.food.map((r) => {
                                                ...
                                                return (
                                                    <tr key={k} style={{ borderTop: "1px solid rgba(255,255,255,0.10)" }}>
                                                        <td style={{ padding: "10px 8px", opacity: 0.8 }}>{r.numericId}</td>
                                                        ...
                                                        <td style={{ padding: "10px 8px" }}>
                                                            <label style={{ display: "inline-flex", gap: 8, alignItems: "center" }}>
                                                                <input
                                                                    ...
                                                                    disabled={disabled}
                                                                    onChange={(e) => toggleDisponibile(r, e.target.checked)}
                                                                />
